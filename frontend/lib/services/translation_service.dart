...
class Translation {
  ...
  static final Map<String, Map<String, String>> _keys = {
    'ta': {
      ...
      'logout': 'வெளியேறு',
      'finance_title': 'நிதி மேலாண்மை',
      'total_income': 'மொத்த வருமானம்',
      'total_expense': 'மொத்த செலவு',
      'net_balance': 'நிகர இருப்பு',
      'add_expense': 'செலவு பதிவு செய்',
      'edit_expense': 'செலவு விவரம் திருத்து',
      'expense_added': 'செலவு பதிவு வெற்றிகரமாக சேர்க்கப்பட்டது',
      'expense_updated': 'செலவு பதிவு வெற்றிகரமாக புதுப்பிக்கப்பட்டது',
      'expense_cancelled': 'செலவு பதிவு வெற்றிகரமாக ரத்து செய்யப்பட்டது',
      'expense_date': 'செலவு செய்த நாள்',
      'expense_category': 'செலவு வகை',
      'expense_description': 'விளக்கம் / குறிப்பு',
      'reference_no': 'குறிப்பு எண் (Reference No)',
      'all_transactions': 'அனைத்து பரிவர்த்தனைகள்',
      'income': 'வருமானம்',
      'expense': 'செலவு',
      'from_date': 'தொடக்க நாள்',
      'to_date': 'முடிவு நாள்',
    ...
    'en': {
      ...
      'expense_added': 'Expense logged successfully',
      'expense_updated': 'Expense updated successfully',
      'expense_cancelled': 'Expense cancelled successfully',
